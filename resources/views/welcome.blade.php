            ...
            @foreach ($mobileProducts as $product)
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                  <img src="{{ asset('images/' . $product->image) }}" alt="product-item" class="img-fluid">
              ...
              @foreach ($testimonials as $testimonial)
                <div class="swiper-slide text-center d-flex justify-content-center">
                  <div class="review-item col-md-10">
                    ...
                    <div class="rating">
                    @for ($i = 0; $i < 5; $i++)
                                        <svg class="star {{ $i < $testimonial->rating ? 'star-fill' : 'star-empty' }}">
                                            <use xlink:href="#star{{ $i < $testimonial->rating ? '-fill' : '-empty' }}"></use>
                                        </svg>
                                    @endfor
               
                    </div>
                    <div class="author-detail">
                    <div class="name text-dark text-uppercase pt-2">{{ $testimonial->author }}</div>
                    </div>
                  </div>
                </div>
                <div class="swiper-slide text-center d-flex justify-content-center">
